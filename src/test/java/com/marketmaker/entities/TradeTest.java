...
class TradeTest {
    @Test void retainsImmutableTradeFieldsIncludingOptionalPnl() {
        Instant time = Instant.EPOCH; Trade trade = new Trade("id", "AAPL", Order.Side.SELL, 2, 12.5, time, 5d); Trade opening = new Trade("open", "AAPL", Order.Side.BUY, 1, 1, time, null);
