...
class PresentersAndViewModelTest {
    ...
    @Test void presentersForwardSuccessAndFailureToTheirViewModels() {
        ...
        ViewModel<ViewCandlestickChartResponseModel> chart = new ViewModel<>(); ViewCandlestickChartResponseModel chartResponse = new ViewCandlestickChartResponseModel("AAPL", Resolution.ONE_DAY, List.<Candle>of());
